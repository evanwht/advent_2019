...
class Grid:
	...
	def get(self, pos):
		if pos[0] in self.spaces and pos[1] in self.spaces[pos[0]]:
			return self.spaces[pos[0]][pos[1]]
		return 0

	def set(self, pos, val):
		if pos[0] not in self.spaces:
			self.spaces[pos[0]] = {}
		self.spaces[pos[0]][pos[1]] = val
